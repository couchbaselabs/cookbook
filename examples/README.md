...
* [Similarity Search using Couchbase](../examples/couchbase/couchbase_similarity_search.ipynb): Use [Couchbase](https://www.couchbase.com/), a NoSQL database with vector search capabilities, to store embeddings generated by the Gemini API, and learn how to use the Couchbase SDK to perform vector search on documents.
